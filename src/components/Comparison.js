  ...
  render() {
    ...
    const mmPlot = (
      <Plot
        ...
        plotData={[
          {
            x: this.props.minmax.func_plot[0],
            y: this.props.minmax.func_plot[1]
          },
      ...
      <Plot
        ...
        plotData={[
          { ...this.props.lssq.error_plot, name: "МНК" },
          {
            ...
            y:
              this.props.minmax.error_plot.length > 0
                ? this.props.minmax.error_plot[1].map(y => -y)
                : this.props.minmax.error_plot[1],
            name: "Мінімакс"
          }
        ]}
      />
              ...
              <Table>
                <TableBody displayRowCheckbox={false}>
                  ...
                  <TableRow>
                    ...
                    <TableRowColumn>
                      {this.props.minmax.max_err.toFixed(4)}
                    </TableRowColumn>
                    <TableRowColumn>
                      {this.props.lssq.max_error.toFixed(4)}
                    </TableRowColumn>
                  </TableRow>
                  <TableRow>
                    <TableRowColumn width={"20%"}>
                    ...
                    <TableRowColumn>
                      {this.props.minmax.x_of_max_err.toFixed(4)}
                    </TableRowColumn>
                    <TableRowColumn>
                      {this.props.lssq.x_of_max_error.toFixed(4)}
                    </TableRowColumn>
                  </TableRow>
                  <TableRow>
                    <TableRowColumn width={"20%"}>
                    ...
                    <TableRowColumn>
                      <Formula
                        formula={this.props.minmax.polynom_latex.replace(
                          truncateCoefs(4),
                          "$1"
                        )}
                      />
                    ...
                    <TableRowColumn>
                      <Formula
                        formula={this.props.lssq.formula.replace(
                          truncateCoefs(4),
                          "$1"
                        )}
                      />
